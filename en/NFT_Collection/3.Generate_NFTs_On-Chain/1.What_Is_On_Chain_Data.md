...
After that, we're going to learn how to _dynamically generate_ these NFTs on our contract. So, **every time someone mints an NFT they'll get a different, hilarious three-word combo**. For example:
